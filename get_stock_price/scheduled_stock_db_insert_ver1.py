...
from get_stock_price.schedule_and_backup import PyBackUp
...
class FunctionComposer():
    ...
    def close(self):
        ...
        """
        [func.close() for func in self.function_list]
...
if __name__ == "__main__":
    ...
    func_composer = FunctionComposer([nikkei_kobetsu_insert, tosho_kobetsu_insert], use_close=True)
